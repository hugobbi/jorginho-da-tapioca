...
from advsearch.jorginho_da_tapioca.othello_minimax_count import evaluate_count 
from advsearch.jorginho_da_tapioca.othello_minimax_mask import evaluate_mask  
